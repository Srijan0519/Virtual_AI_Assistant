...
IMAGE_API_KEY= "7AkBIer9MZT0qpSRNXSWdYVXLKaONee6l7aciB5o5n4"
...
# How to embed images
# 1. Extract keywords from user's query and look for images with labels having relevant metadata tags using Unsplash. Then copy image-address from https://commons.wikimedia.org/w/index.php?:MediaSearch&go=Go&type=image. Embed the file like this:
